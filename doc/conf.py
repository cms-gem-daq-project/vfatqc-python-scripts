...
man_pages = [
    ...
    ('man/dacScanV3', 'dacScanV3.py', u'Perform a VFAT3 DAC scan on all unmasked optohybrids',
     authors, 1),
    ('man/ultrLatency', 'ultraLatency.py', u'Perform a Latency Scan',
     authors, 1),
    ('man/monitorTemperatures', 'monitorTemperatures.py', u'Record Temperature Data',
     authors, 1),
    ('man/checkSbitMappingAndRate', 'checkSbitMappingAndRate.py', u'Investigate sbit Mapping and Rate Measurement',
     authors, 1),
